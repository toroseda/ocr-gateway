package ae.etisalat.eim.ocr.gateway.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "OcrGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "OcrGateway API";

        private String description = "OcrGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "OcrGateway";
