...
/**
 * Performance test for the OcrSession entity.
 */
class OcrSessionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the OcrSession entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created ocrSession")
                .get("${new_ocrSession_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created ocrSession")
            .delete("${new_ocrSession_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
